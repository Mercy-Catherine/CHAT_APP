...
const SignUpPage = () => {
  ...
  if (status === "DELI") {
    signup(formData);
  } else if (status === "UNDELI") {
    toast.error("Email doesn't appear to be deliverable.");
  } else {
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center mb-8">
          <div className="flex flex-col items-center gap-2 group">
            <div className="size-12 rounded-xl bg-slate-600 flex items-center justify-center group-hover:bg-blue-200 transition-colors">
